...
class Solution:
    ...
    def part1(self, binary_numbers: List[str]) -> int:
    ...
    def part2(self, binary_numbers: List[str]) -> int:
        def filter_numbers(numbers, bit_criteria):
        ...
        co2_scrubber_rating = filter_numbers(binary_numbers[:], 'least_common')
