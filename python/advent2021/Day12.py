...
class Solution:
    ...
    def __init__(self, file: str):
        ...
        self.graph = self._init_graph(lines)

    def _init_graph(self, lines):
        g = {}
        for l in lines:
            a, b = l.split('-')
            if a not in g:
    ...
    def find_all_paths_part1(self):
        paths_q = []
        complete_paths = []

        paths_q.append(['start'])
    ...
    def part1(self):
        return len(self.find_all_paths_part1())
    
    def find_all_paths_part2(self):
        paths_q = []
        complete_paths = []

        paths_q.append((['start'], False)) # second element is a flag to indicate if a small cave has been visited twice
    ...
    def part2(self):
        return len(self.find_all_paths_part2())
