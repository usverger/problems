...
# Realizing what you're trying to do, the submarine automatically produces a list of the ages of several hundred nearby lanternfish
...
# and so on until the fifth fish, which has an internal timer of 2. Simulating these fish over several days would proceed as follows:
...
class Solution:
    ...
    def __init__(self, input: str):
        self.initial = list(map(int, input.split(',')))

    def solve(self, days: int) -> int:
        fishes = self.initial.copy()
        for d in range(days):
