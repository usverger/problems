...
class LinkedLists(unittest.TestCase):
    ...
    def test_isPalindrome(self):
        ...
        l = problems.DesignLinkedList.MyLinkedList([1,2,2,1])
        self.assertEqual(l.isPalindrome(), True)

        l = problems.DesignLinkedList.MyLinkedList([1,2,5,2,1])
        self.assertEqual(l.isPalindrome(), True)

    def test_oddEvenList(self):
        l = problems.DesignLinkedList.MyLinkedList([1,2,3,4,5])
        l.oddEvenList()
    ...
    def test_removeElements(self):
        l = problems.DesignLinkedList.MyLinkedList([6,1,2,6,3,4,5,6])
        l.removeElements(6)
        self.assertEqual(l.get(0), 1)
        self.assertEqual(l.get(1), 2)
        self.assertEqual(l.get(2), 3)
    ...
    def test_removeNthFromEnd(self):
        l = problems.DesignLinkedList.MyLinkedList([4,1,8,4,5]) 
    ...
    def test_detectCycle(self):
        ...
        l = problems.DesignLinkedList.MyLinkedList([1,2,3])
