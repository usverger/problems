...
move 4 from 2 to 8'''
    ...
    def test_day06_part2(self):
        s = advent2022.Day06.Solution()
        self.assertEqual(19, s.result('''mjqjpqmgbljsphdztnvjfqwrcgsmlb''', 14))
        self.assertEqual(23, s.result('''bvwbjplbgvbhsrlpgdmjqwftvncz''', 14))
        self.assertEqual(23, s.result('''nppdvjthqldpwncqszvftbrmjlhg''', 14))
        self.assertEqual(29, s.result('''nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg''', 14))
        self.assertEqual(26, s.result('''zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw''', 14))

    def test_day06_part2_puzzle(self):
        s = advent2022.Day06.Solution()
        text = ''''''
        print('\n')
        result = s.result(text, 14)
        print(result)
